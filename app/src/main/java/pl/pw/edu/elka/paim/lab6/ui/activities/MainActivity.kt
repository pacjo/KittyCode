        ...
        Column(
            ...
            codeInfo?.let { codeInfo ->
                Column(
                    ...
                    FilledTonalButton(
                        onClick = { openDetailsActivity(context, codeInfo) },
                        shape = squareShape
                    ) {
...
private fun openDetailsActivity(context: Context, statusCodeInfo: StatusCodeInfo) {
    val intent = Intent(context, DetailsActivity::class.java)
    intent.putExtra(StatusCodeInfo.INTENT_EXTRA, statusCodeInfo)
